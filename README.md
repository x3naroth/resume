...
- Rest energy of the electron through Compton effect: The rest energy of an electron was determined using the Compton equation for collision with
a photon, using an X-ray emitter generated by a Carbon scatterer. Gnuplot was used to make linear regressions and plotting the results [Research document](https://www.overleaf.com/read/nhnzbpwxpznd)
